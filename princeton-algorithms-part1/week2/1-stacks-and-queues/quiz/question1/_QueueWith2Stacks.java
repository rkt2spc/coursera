...
class QueueWith2Stacks {
  ...
  public static class FastInQueueWith2Stacks<T> implements IQueue<T> {
  ...
  public static class FastOutQueueWith2Stacks<T> implements IQueue<T> {
    private Stack<T> s1 = new Stack<T>();
    private Stack<T> s2 = new Stack<T>();
  ...
  public static void main(String[] args) {
    var q = new FastInQueueWith2Stacks<Integer>();
    q.enqueue(1);
    q.enqueue(2);
    ...
    var q2 = new FastOutQueueWith2Stacks<Integer>();
    q2.enqueue(1);
    q2.enqueue(2);
