// https://coursera.cs.princeton.edu/algs4/assignments/collinear/files/Point.java
/******************************************************************************
...
public class Point implements Comparable<Point> {
  ...
  public static void main(String[] args) {
    Point p = new Point(21, 250);
    Point q = new Point(482, 30);
    Point r = new Point(269, 172);
    System.out.printf("p.slopeOrder().compare(q, r) = %d\n", p.slopeOrder().compare(q, r));
    System.out.printf("p.slopeOrder().compare(r, q) = %d\n", p.slopeOrder().compare(r, q));
  }
}
